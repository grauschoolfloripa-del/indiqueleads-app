            ...
            <form onSubmit={handleAddProductSubmit} className="space-y-4">
              ...
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <span className="block text-xs font-bold text-slate-800 uppercase mb-3">
                  Atributos Técnicos Específicos ({newProductCategory.toUpperCase()})
                </span>
                    ...
                    <div>
                      ...
                      <select
                        onChange={(e) =>
                          setProductForm({
                            ...productForm,
                            attributes: { ...productForm.attributes, type: e.target.value },
                          })
                        }
                        ...
                        onChange={(e) =>
                          setProductForm({
                            ...
                            attributes: {
                              ...
                              areaUseful: Number(e.target.value),
                            },
                          })
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setProductForm({
                            ...productForm,
                            attributes: { ...productForm.attributes, registryId: e.target.value },
                          })
                        }
                        className="w-full bg-white border border-slate-200 rounded px-2 py-1"
                      />
                ...
                {newProductCategory === "carro" && (
                  <div className="grid grid-cols-3 gap-3 text-xs">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setProductForm({
                            ...productForm,
                            attributes: { ...productForm.attributes, km: Number(e.target.value) },
                          })
                        }
                        className="w-full bg-white border border-slate-200 rounded px-2 py-1"
                      />
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        placeholder="Cinza Giz"
                        onChange={(e) =>
                          setProductForm({
                            ...productForm,
                            attributes: { ...productForm.attributes, color: e.target.value },
                          })
                        }
                        className="w-full bg-white border border-slate-200 rounded px-2 py-1"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setProductForm({
                            ...productForm,
                            attributes: { ...productForm.attributes, transmission: e.target.value },
                          })
                        }
                        className="w-full bg-white border border-slate-200 rounded px-2 py-1"
                      />
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        placeholder="E*A-9E11"
                        required
                        onChange={(e) =>
                          setProductForm({
                            ...productForm,
                            attributes: { ...productForm.attributes, plate: e.target.value },
                          })
                        }
                        className="w-full bg-white border border-slate-200 rounded px-2 py-1"
                      />
                      ...
                      <select
                        onChange={(e) =>
                          setProductForm({
                            ...
                            attributes: {
                              ...productForm.attributes,
                              cautionaryReport: e.target.value === "sim",
                            },
                          })
                        }
                        className="w-full bg-white border border-slate-200 rounded px-2 py-1"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setProductForm({
                            ...productForm,
                            attributes: { ...productForm.attributes, cc: Number(e.target.value) },
                          })
                        }
                        className="w-full bg-white border border-slate-200 rounded px-2 py-1"
                      />
                ...
                {newProductCategory === "barco" && (
                  <div className="grid grid-cols-3 gap-3 text-xs">
                    <div>
                      <label className="block text-[10px] text-slate-500 mb-1 font-semibold">
                        Estaleiro (Fabricante)
                      </label>
                      <input
                        type="text"
                        placeholder="NX Boats"
                        required
                        onChange={(e) =>
                          setProductForm({
                            ...productForm,
                            attributes: { ...productForm.attributes, builder: e.target.value },
                          })
                        }
                        className="w-full bg-white border border-slate-200 rounded px-2 py-1"
                      />
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setProductForm({
                            ...
                            attributes: {
                              ...productForm.attributes,
                              engineHours: Number(e.target.value),
                            },
                          })
                        }
                        className="w-full bg-white border border-slate-200 rounded px-2 py-1"
