        ...
        <form onSubmit={handleRegisterOnboard} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <p className="mb-2">
                <strong className="text-orange-400">CLÁUSULA 1ª - DA AUTONOMIA REAL:</strong> O
              ...
              <p className="mb-2">
                <strong className="text-orange-400">CLÁUSULA 2ª - DA MULTIPLICIDADE:</strong> É
              ...
              <p className="mb-2">
                <strong className="text-orange-400">CLÁUSULA 3ª - DA EXCLUSÃO DE VÍNCULO:</strong>{" "}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <h4 className="font-display font-bold text-sm text-slate-900 flex items-center gap-1.5">
                          ...
                          <span className="text-orange-600 font-extrabold font-mono text-xs bg-orange-100 px-2.5 py-0.5 rounded-full uppercase">
                            {indicator.city} - {indicator.state}
                          </span>
                        </h4>
                      ...
                      {sortedRegionalHighlights.map((prod) => {
                        ...
                        return (
                          <div
                            ...
                            className="bg-white rounded-2xl p-3 border border-orange-100 hover:border-orange-200/80 shadow-xs transition-all flex flex-col justify-between"
                          >
                            <div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-4 flex-1 flex flex-col justify-between">
                        <div>
                          <span className="text-[10px] text-orange-600 font-bold tracking-wider uppercase font-mono">
                            {prod.advertiserName}
                          </span>
                    ...
                    {activeLeads.map((lead) => {
                      ...
                      return (
                        <>
                          <tr
                            key={lead.id}
                            className={`hover:bg-slate-50/50 transition-all ${isChatOpen ? "bg-orange-50/20" : ""}`}
                          >
                            ...
                            <td className="py-4 px-4 font-mono font-semibold uppercase text-[10px]">
                              {lead.commissionType === "presencial" ? (
                                ...
                                <span className="text-orange-600 bg-orange-50 border border-orange-100 px-2 py-0.5 rounded-full">
                                  Digital
                                </span>
                              )}
                            </td>
                    ...
                    return (
                      <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 space-y-3.5 text-xs text-slate-800 animate-slide-in">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="bg-orange-100 text-orange-800 rounded-full w-5 h-5 flex items-center justify-center font-bold text-[10px] flex-shrink-0 mt-0.5">
                            1
                          </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-1 text-left">
                      <p className="text-[10px] font-mono uppercase tracking-wider text-orange-400 font-bold">
