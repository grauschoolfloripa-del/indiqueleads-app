...
import { 
  Sparkles, Award, Building2, ShieldAlert, CheckCircle2, AlertCircle, 
  ArrowRight, Lock, Shield, UserCheck, PlusCircle, Check, HelpCircle, 
...
export default function LandingPage({
  ...
  const [activeSection, setActiveSection] = useState<'home' | 'niches' | 'how-it-works' | 'how-to-profit' | 'how-to-sell'>('home');
  ...
  const calculatedEarnings = calcType === 'digital' 
    ? totalAdvertiserCommission * 0.15 
    : totalAdvertiserCommission * 0.35;

  const handleQuickLogin = (email: string, pass: string, role: 'indicador' | 'anunciante' | 'admin') => {
    setAuthRole(role);
  ...
  const handleRegisterSubmit = (e: React.FormEvent) => {
    ...
    if (authRole === 'indicador') {
      if (!regIndName || !regIndEmail || !regIndPassword || !regIndCpf || !regIndPixKey || !regIndCity || !regIndState) {
        setErrorMsg('Preencha os campos obrigatórios (Nome, E-mail, Senha, CPF, Chave PIX, Cidade e Estado).');
        return;
      }
      onRegisterIndicator({
        name: regIndName,
      ...
      if (!regAdvName || !regAdvEmail || !regAdvPassword || !regAdvCnpjOrCpf || !regAdvCity || !regAdvState) {
        setErrorMsg('Preencha os campos obrigatórios (Nome da Empresa, E-mail, Senha, CNPJ/CPF, Cidade e Estado).');
        return;
      }
      onRegisterAdvertiser({
        name: regAdvName,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              <a 
                href="#nichos" 
                onClick={(e) => { e.preventDefault(); setActiveSection('niches'); document.getElementById('nichos')?.scrollIntoView({ behavior: 'smooth' }); }}
              ...
              <a 
                href="#como-funciona" 
                onClick={(e) => { e.preventDefault(); setActiveSection('how-it-works'); document.getElementById('como-funciona')?.scrollIntoView({ behavior: 'smooth' }); }}
              ...
              <a 
                href="#como-lucrar" 
                onClick={(e) => { e.preventDefault(); setActiveSection('how-to-profit'); document.getElementById('como-lucrar')?.scrollIntoView({ behavior: 'smooth' }); }}
              ...
              <a 
                href="#anunciar" 
                onClick={(e) => { e.preventDefault(); setActiveSection('how-to-sell'); document.getElementById('anunciar')?.scrollIntoView({ behavior: 'smooth' }); }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-black tracking-tight text-slate-900 leading-[1.1]">
                Indique Leads Premium e <span className="text-orange-600 relative inline-block">ganhe comissões<span className="absolute left-0 bottom-1 w-full h-2 bg-orange-200 -z-10 rounded"></span></span> via PIX.
              </h1>
              <p className="text-base sm:text-lg text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Conectamos indicadores autônomos a grandes marcas de carros, imóveis, lanchas e motos aquáticas. Indique amigos ou leads qualificados e receba pagamentos expressivos em cada venda finalizada.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-slate-100 max-w-lg mx-auto lg:mx-0">
                <div>
                  ...
                  <span className="text-[10px] text-slate-500 uppercase font-semibold">Comissões Pagas</span>
                </div>
                <div>
                  <span className="block text-xl font-bold text-slate-900">12k+</span>
                  <span className="text-[10px] text-slate-500 uppercase font-semibold">Leads Gerados</span>
                </div>
                <div>
                  <span className="block text-xl font-bold text-slate-900">100%</span>
                  <span className="text-[10px] text-slate-500 uppercase font-semibold">Auditado em Tempo Real</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="bg-slate-900 rounded-3xl p-6 text-white shadow-2xl relative overflow-hidden border border-slate-800">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex items-center gap-3">
                    ...
                    <div className="text-right">
                      <span className="text-xs text-orange-400 font-mono block font-bold">R$ 18.000</span>
                  ...
                  <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex items-center gap-3">
                    ...
                    <div className="text-right">
                      <span className="text-xs text-orange-400 font-mono block font-bold">R$ 5.500</span>
                      <span className="text-[9px] text-slate-500 block">Comissão Indicação</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-950/50 p-4 rounded-2xl border border-dashed border-slate-800">
                    <span className="text-[9px] text-slate-400 uppercase tracking-widest block font-bold mb-2">Histórico de Atividade Recente</span>
                ...
                <div className="mt-5 text-center">
                  <p className="text-[11px] text-slate-400">Você indica usando um link inteligente exclusivo gerado na hora.</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              Trabalhamos exclusivamente com bens de alto ticket. Isso significa que uma única indicação sua que resulte em venda garante comissões maiores do que meses de trabalho comum.
            </p>
          </div>
            ...
            {nichesData.map((niche) => (
              ...
              >
                <div>
                  ...
                  <h3 className="font-display font-bold text-slate-900 text-lg leading-snug mb-2">{niche.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-slate-600 text-sm">
              Desenvolvemos dois painéis totalmente automatizados para que Indicadores e Anunciantes acompanhem cada etapa com integridade.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-display font-black text-slate-900 text-xl">Para o Indicador Autônomo</h3>
              </div>

              <div className="space-y-6">
                <div className="flex gap-4">
                  <span className="w-8 h-8 rounded-full bg-orange-100 text-orange-800 flex items-center justify-center font-bold text-xs flex-shrink-0">1</span>
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">Cadastre-se na Plataforma</h4>
                    <p className="text-slate-600 text-xs">Crie seu cadastro informando seus dados básicos e sua Chave PIX para pagamentos automáticos.</p>
                  </div>
                </div>

                <div className="flex gap-4">
                  <span className="w-8 h-8 rounded-full bg-orange-100 text-orange-800 flex items-center justify-center font-bold text-xs flex-shrink-0">2</span>
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">Escolha Produtos na Vitrine</h4>
                    <p className="text-slate-600 text-xs">Acesse a vitrine com dezenas de carros, lanchas, imóveis e jetskis autorizados para indicações.</p>
                  </div>
                </div>

                <div className="flex gap-4">
                  <span className="w-8 h-8 rounded-full bg-orange-100 text-orange-800 flex items-center justify-center font-bold text-xs flex-shrink-0">3</span>
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">Compartilhe seu Link Exclusivo</h4>
                    <p className="text-slate-600 text-xs">Obtenha o link de indicação gerado pelo sistema e envie ao seu cliente interessado ou cadastre os dados dele diretamente no painel.</p>
                  </div>
                </div>

                <div className="flex gap-4">
                  <span className="w-8 h-8 rounded-full bg-orange-100 text-orange-800 flex items-center justify-center font-bold text-xs flex-shrink-0">4</span>
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">Acompanhe pelo Funil de Vendas</h4>
                    <p className="text-slate-600 text-xs">Receba atualizações imediatas no painel: quando o anunciante faz contato, agenda a visita e fecha a proposta.</p>
                  </div>
                </div>

                <div className="flex gap-4">
                  <span className="w-8 h-8 rounded-full bg-emerald-100 text-emerald-800 flex items-center justify-center font-bold text-xs flex-shrink-0">✓</span>
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">Saque seu Saldo via PIX</h4>
                    <p className="text-slate-600 text-xs font-semibold text-emerald-700">Quando a venda é concluída, a comissão é liberada para saque instantâneo.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-display font-black text-slate-900 text-xl">Para o Anunciante (Vendedor)</h3>
              </div>

              <div className="space-y-6">
                <div className="flex gap-4">
                  <span className="w-8 h-8 rounded-full bg-slate-100 text-slate-800 flex items-center justify-center font-bold text-xs flex-shrink-0">1</span>
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">Cadastre sua Empresa</h4>
                    <p className="text-slate-600 text-xs">Faça login com CNPJ ou CPF particular, escolha suas verticais de venda e assine um plano.</p>
                  </div>
                </div>

                <div className="flex gap-4">
                  <span className="w-8 h-8 rounded-full bg-slate-100 text-slate-800 flex items-center justify-center font-bold text-xs flex-shrink-0">2</span>
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">Publique Seus Bens</h4>
                    <p className="text-slate-600 text-xs">Insira fotos, descrições detalhadas, valor de mercado e a porcentagem de comissão digital e presencial que você deseja pagar.</p>
                  </div>
                </div>

                <div className="flex gap-4">
                  <span className="w-8 h-8 rounded-full bg-slate-100 text-slate-800 flex items-center justify-center font-bold text-xs flex-shrink-0">3</span>
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">Receba Leads Auditados</h4>
                    <p className="text-slate-600 text-xs">Os leads gerados por promotores caem instantaneamente no seu painel. O promotor pode ainda fazer check-in de visita via GPS.</p>
                  </div>
                </div>

                <div className="flex gap-4">
                  <span className="w-8 h-8 rounded-full bg-slate-100 text-slate-800 flex items-center justify-center font-bold text-xs flex-shrink-0">4</span>
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">Atualize o Status do Atendimento</h4>
                    <p className="text-slate-600 text-xs">Mova o lead pelo funil (Contato Feito → Visita Agendada → Proposta) mantendo a transparência e confiança com o indicador.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-xs font-semibold text-emerald-700">Ao faturar, envie a Nota Fiscal ou contrato simplificado de comprovação de venda para liberar a comissão do promotor.</p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 bg-slate-50 p-6 sm:p-8 rounded-3xl border border-slate-200/60 shadow-md">
              ...
              <h3 className="font-display font-bold text-slate-900 text-2xl mt-3 mb-6">Quanto eu posso lucrar por indicação?</h3>
              ...
              <div className="space-y-5">
                ...
                <div>
                  <div className="flex justify-between text-xs font-bold mb-1">
                    ...
                    <span className="text-slate-900">R$ {calcSaleValue.toLocaleString('pt-BR')}</span>
                  </div>
                  <input 
                    type="range" 
                ...
                <div>
                  <div className="flex justify-between text-xs font-bold mb-1">
                    <span className="text-slate-500 uppercase">Comissão Total Oferecida pelo Vendedor</span>
                    <span className="text-slate-900">{calcCommPct}% (R$ {totalAdvertiserCommission.toLocaleString('pt-BR')})</span>
                  </div>
                  <input 
                    type="range" 
                    min={1}
                ...
                {/* 4. Type Selector */}
                <div>
                  <label className="block text-xs text-slate-500 font-bold uppercase mb-2">Qual seu nível de envolvimento?</label>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      <span className="block font-bold text-slate-900 text-xs">Apenas Indicação (Digital)</span>
                      <span className="block text-[10px] text-slate-500 mt-1">Você apenas envia o link ou cadastra os contatos do lead. Comissão de 15% da verba.</span>
                    </button>
                    <button
                    ...
                    >
                      <span className="block font-bold text-slate-900 text-xs">Visita Acompanhada (Presencial)</span>
                      <span className="block text-[10px] text-slate-500 mt-1">Você acompanha o lead presencialmente na visita de demonstração. Comissão de 35% da verba.</span>
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-orange-600 text-white p-5 rounded-2xl shadow-md space-y-1 text-center">
                  <span className="text-[10px] uppercase font-bold tracking-widest text-orange-200">Sua Comissão Estimada via PIX</span>
                  <div className="text-3xl font-display font-black">
                    R$ {calculatedEarnings.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                  </div>
                  <p className="text-[10px] text-orange-100">Simulação baseada no regulamento de comissões autônomas IndicaAqui.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <p className="text-slate-600 text-sm">
                Na nossa plataforma, você tem total liberdade. Não exigimos dedicação exclusiva ou metas. Você pode trabalhar indicando contatos do seu círculo social de forma digital ou atuando de forma ativa acompanhando visitas.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-950 text-sm mb-1">Indicação Digital Direta (Sem Burocracia)</h4>
                    <p className="text-slate-600 text-xs">Simplesmente identifique um amigo, colega ou familiar interessado em comprar um carro ou imóvel. Gere seu link de indicação, envie a ele, e quando ele preencher, ele se torna seu lead com cookie ativado por 60 dias.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-950 text-sm mb-1">Acompanhamento Presencial (Comissão Turbinada)</h4>
                    <p className="text-slate-600 text-xs">Quer lucrar 2x ou 3x mais? No agendamento da visita, opte por acompanhar o lead presencialmente na imobiliária, marina ou concessionária. Utilize nosso app de celular para realizar o check-in por GPS auditado para validar sua comissão.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-950 text-sm mb-1">Parceria Legal Protegida (Art. 442-B da CLT)</h4>
                    <p className="text-slate-600 text-xs">Todo cadastro assina digitalmente um Contrato de Parceria Autônoma, blindando juridicamente as duas pontas contra vínculo trabalhista, garantindo total conformidade legal para anunciantes PJ.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
                Por que queimar dinheiro com anúncios patrocinados frios quando você pode ter centenas de promotores locais motivados indicando leads super quentes e auditados? Na plataforma IndicaAqui, você só paga comissão se a venda for de fato assinada e fechada!
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-slate-950/60 p-4 rounded-2xl border border-white/5">
                  <h4 className="text-orange-400 font-bold text-xs uppercase mb-1">Catálogo Zero-Deploy</h4>
                  <p className="text-slate-400 text-[11px]">Seu anúncio gera automaticamente uma landing page profissional instantânea pronta para converter sem você programar nada.</p>
                </div>
                <div className="bg-slate-950/60 p-4 rounded-2xl border border-white/5">
                  <h4 className="text-orange-400 font-bold text-xs uppercase mb-1">Auditoria de Visitas</h4>
                  <p className="text-slate-400 text-[11px]">Evite fraudes: promotores confirmam visitas tirando foto na fachada da loja ou realizando check-in com GPS no local.</p>
                </div>
                <div className="bg-slate-950/60 p-4 rounded-2xl border border-white/5">
                  <h4 className="text-orange-400 font-bold text-xs uppercase mb-1">Taxa por Lead ou Faturamento</h4>
                  <p className="text-slate-400 text-[11px]">Configure se prefere pagar uma pequena taxa por lead de demonstração ou se prefere o modelo puro de comissão final.</p>
                </div>
                <div className="bg-slate-950/60 p-4 rounded-2xl border border-white/5">
                  <h4 className="text-orange-400 font-bold text-xs uppercase mb-1">Gestão de Leads Completa</h4>
                  <p className="text-slate-400 text-[11px]">Mova os clientes no funil de vendas, registre reuniões e anexe comprovantes de faturamento em um único dashboard.</p>
                </div>
              </div>
            ...
            <div className="lg:col-span-6 bg-slate-950 p-6 rounded-3xl border border-white/5 shadow-2xl space-y-6">
              <h4 className="font-display font-bold text-sm tracking-widest text-slate-400 uppercase text-center border-b border-white/5 pb-3">PLANOS DE ASSINATURA</h4>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-900/50 p-4 rounded-2xl border border-white/5 flex justify-between items-center hover:border-orange-500/30 transition-all">
                  <div>
                    <span className="text-[10px] bg-slate-800 text-slate-300 font-bold uppercase px-2 py-0.5 rounded font-mono">Simples</span>
                  ...
                  <div className="text-right">
                    <span className="text-xs text-slate-400 block font-mono font-bold">R$ 149 /mês</span>
                    <span className="text-[8px] bg-orange-600/20 text-orange-400 px-1.5 py-0.5 rounded">Popular</span>
                  </div>
                </div>
                ...
                <div className="bg-slate-900 p-4 rounded-2xl border border-orange-500/20 flex justify-between items-center hover:border-orange-500/50 transition-all shadow-md shadow-orange-950/50">
                  <div>
                    <span className="text-[10px] bg-orange-600 text-white font-bold uppercase px-2 py-0.5 rounded font-mono">Mais Vendido</span>
                    <h5 className="font-bold text-sm mt-1">Plano Pro (Multi-Vertical)</h5>
                    <p className="text-[10px] text-slate-400">Até 10 anúncios ativos com auditoria GPS.</p>
                  </div>
                  <div className="text-right">
                    <span className="text-xs text-orange-400 block font-mono font-bold">R$ 399 /mês</span>
                    <span className="text-[8px] bg-emerald-600/20 text-emerald-400 px-1.5 py-0.5 rounded">Fidelidade</span>
                  </div>
                </div>
                ...
                <div className="bg-slate-900/50 p-4 rounded-2xl border border-white/5 flex justify-between items-center hover:border-orange-500/30 transition-all">
                  <div>
                    <span className="text-[10px] bg-slate-800 text-slate-300 font-bold uppercase px-2 py-0.5 rounded font-mono">Corporativo</span>
                    <h5 className="font-bold text-sm mt-1">Plano Premium Corporativo</h5>
                    <p className="text-[10px] text-slate-500">Anúncios ilimitados, assessoria jurídica de contratos.</p>
                  </div>
                  <div className="text-right">
                    <span className="text-xs text-slate-400 block font-mono font-bold">R$ 799 /mês</span>
                    <span className="text-[8px] bg-slate-800 text-slate-400 px-1.5 py-0.5 rounded">Premium</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-slate-950 text-slate-400 py-12 border-t border-slate-900 font-mono text-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-3">
            <span className="text-white font-display font-black text-base">IndicaAqui<span className="text-orange-600">.</span></span>
            <p className="text-[11px] text-slate-500 leading-relaxed">A primeira rede de afiliação e comissões para bens de alto padrão no Brasil.</p>
          </div>
          <div>
            <span className="text-white font-bold block mb-3 uppercase text-[10px] tracking-wider">Para Promotores</span>
            <ul className="space-y-1.5 text-[11px]">
              <li><a href="#como-funciona" className="hover:text-white">Passo a Passo</a></li>
              <li><a href="#como-lucrar" className="hover:text-white">Simulador de PIX</a></li>
              <li><button onClick={() => openAuth('indicador')} className="hover:text-white text-left">Login Indicador</button></li>
              <li><button onClick={() => openAuth('indicador', true)} className="hover:text-white text-left">Cadastro Indicador</button></li>
            </ul>
          </div>
          <div>
            <span className="text-white font-bold block mb-3 uppercase text-[10px] tracking-wider">Para Anunciantes</span>
            <ul className="space-y-1.5 text-[11px]">
              <li><a href="#anunciar" className="hover:text-white">Nossos Planos</a></li>
              <li><a href="#nichos" className="hover:text-white">Categorias Aceitas</a></li>
              <li><button onClick={() => openAuth('anunciante')} className="hover:text-white text-left">Painel da Empresa</button></li>
              <li><button onClick={() => openAuth('anunciante', true)} className="hover:text-white text-left">Registrar Conta</button></li>
            </ul>
          </div>
          <div>
            <span className="text-white font-bold block mb-3 uppercase text-[10px] tracking-wider">Segurança Jurídica</span>
            <p className="text-[11px] text-slate-500 leading-relaxed">Contratos digitais baseados no Art. 442-B da CLT. Segurança e transparência fiscal com Nota Fiscal eletrônica ou comprovantes.</p>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl w-full max-w-lg overflow-hidden border border-slate-100 shadow-2xl relative animate-scale-up max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-slate-50 border-b border-slate-100 p-4 pt-6 flex justify-center gap-2">
              <button
                onClick={() => { setAuthRole('indicador'); setErrorMsg(''); setSuccessMsg(''); }}
              ...
              <button
                onClick={() => { setAuthRole('anunciante'); setErrorMsg(''); setSuccessMsg(''); }}
                className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${
                  authRole === 'anunciante' 
                    ? 'bg-orange-600 text-white' 
                    : 'bg-white border border-slate-200 text-slate-600 hover:bg-slate-100'
              ...
              <button
                onClick={() => { setAuthRole('admin'); setIsRegisterMode(false); setErrorMsg(''); setSuccessMsg(''); }}
                className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${
                  authRole === 'admin' 
            ...
            <div className="p-6 sm:p-8 space-y-6">
              <div className="text-center">
                <span className="text-[10px] bg-orange-100 text-orange-800 font-bold uppercase px-2.5 py-1 rounded-full font-mono">
                  {authRole === 'admin' ? 'Acesso Administrativo' : isRegisterMode ? 'Cadastro Completo' : 'Área Restrita'}
                </span>
                ...
                {authRole !== 'admin' && (
                  <p className="text-xs text-slate-500 mt-1">
                    {isRegisterMode ? 'Preencha o formulário abaixo' : 'Entre com e-mail e senha cadastrados'}
                  </p>
                )}
              </div>
              ...
              {!isRegisterMode ? (
                ...
                <form onSubmit={handleLoginSubmit} className="space-y-4">
                  <div>
                    <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">E-mail de Acesso</label>
                    <input 
                      type="email" 
                      required
                      placeholder={authRole === 'admin' ? 'admin@indicaaqui.com' : 'ex: gabriel@exemplo.com'}
                      value={loginEmail}
                  ...
                  <div>
                    <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Senha Secreta</label>
                    <input 
                      type="password" 
                      required
                      placeholder="••••••••"
                  ...
                  <div className="mt-5 pt-4 border-t border-slate-100 text-center">
                    <span className="text-[9px] font-bold uppercase tracking-wider text-slate-400">Acesso Rápido (Demonstração)</span>
                    <div className="mt-2 grid grid-cols-3 gap-2">
                      <button
                        type="button"
                        onClick={() => handleQuickLogin('gabriel.martins@indica.com', 'senha123', 'indicador')}
                      ...
                      <button
                        type="button"
                        onClick={() => handleQuickLogin('contato@vanguardluxo.com.br', 'senha123', 'anunciante')}
                      ...
                      <button
                        type="button"
                        onClick={() => handleQuickLogin('admin@indicaaqui.com', 'admin123', 'admin')}
                  ...
                  {authRole === 'indicador' ? (
                    ...
                    <>
                      <div>
                        ...
                        <input 
                          type="text" required placeholder="ex: Roberto Carlos" value={regIndName}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">E-mail</label>
                          <input 
                            type="email" required placeholder="roberto@email.com" value={regIndEmail}
                            onChange={(e) => setRegIndEmail(e.target.value)}
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-xs focus:ring-2 focus:ring-orange-500 focus:outline-none"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Senha</label>
                          <input 
                            type="password" required placeholder="Mínimo 6 caracteres" value={regIndPassword}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <input 
                            type="text" required placeholder="000.000.000-00" value={regIndCpf}
                            onChange={(e) => setRegIndCpf(e.target.value)}
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-xs focus:ring-2 focus:ring-orange-500 focus:outline-none"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">WhatsApp / Telefone</label>
                          <input 
                            type="text" placeholder="(11) 99999-9999" value={regIndPhone}
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div className="col-span-1">
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Tipo de PIX</label>
                          <select 
                            value={regIndPixType} 
                        ...
                        <div className="col-span-2">
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Chave PIX de Recebimento</label>
                          <input 
                            type="text" required placeholder="Chave para transferências" value={regIndPixKey}
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div className="col-span-2">
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Cidade de Atuação</label>
                          <input 
                            type="text" required placeholder="ex: São Paulo" value={regIndCity}
                            onChange={(e) => setRegIndCity(e.target.value)}
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs focus:ring-2 focus:ring-orange-500 focus:outline-none"
                          />
                        </div>
                        <div className="col-span-1">
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Estado (UF)</label>
                          <select 
                            value={regIndState} 
                    ...
                    <>
                      <div>
                        <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Nome Fantasia da Empresa</label>
                        <input 
                          type="text" required placeholder="ex: Incorporadora Sul" value={regAdvName}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">E-mail Corporativo</label>
                          <input 
                            type="email" required placeholder="contato@empresa.com" value={regAdvEmail}
                        ...
                        <div>
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Senha</label>
                          <input 
                            type="password" required placeholder="Min. 6 caracteres" value={regAdvPassword}
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div className="col-span-1">
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Tipo</label>
                          <select 
                            value={regAdvType} 
                        ...
                        <div className="col-span-2">
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Documento (CNPJ/CPF)</label>
                          <input 
                            type="text" required placeholder="CNPJ ou CPF" value={regAdvCnpjOrCpf}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">WhatsApp / Comercial</label>
                          <input 
                            type="text" placeholder="(11) 98888-8888" value={regAdvPhone}
                            onChange={(e) => setRegAdvPhone(e.target.value)}
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-xs focus:ring-2 focus:ring-orange-500 focus:outline-none"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Plano Pretendido</label>
                          <select 
                            value={regAdvPlan} 
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div className="col-span-2">
                          <label className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Cidade da Sede / Loja</label>
                          <input 
                            type="text" required placeholder="ex: Rio de Janeiro" value={regAdvCity}
