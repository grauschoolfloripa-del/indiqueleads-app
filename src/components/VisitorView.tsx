        ...
        <div className="bg-gradient-to-r from-blue-950 via-slate-900 to-slate-950 border border-blue-500/20 text-white rounded-2xl p-4 mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow">
          <div>
            ...
            <p className="text-xs text-slate-300 mt-0.5">
              Você foi direcionado a esta oferta exclusiva pelo parceiro comercial{" "}
              <strong>{referralIndicatorName || "Gabriel Martins"}</strong>.
            </p>
          </div>
            ...
            <button
              onClick={() => {
                ...
                const key =
                  ...
                  localStorage.getItem("indica_client_lookup_key") ||
                  "";
                if (key) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="space-y-1.5">
              <span className="text-xs text-slate-400 uppercase font-bold tracking-wider font-mono">
                {product.advertiserName}
              </span>
              <h1 className="font-display font-bold text-slate-950 text-2xl sm:text-3xl tracking-tight">
                {product.title}
              </h1>
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-xl p-6 sticky top-28 space-y-5">
              <div className="text-center border-b border-slate-100 pb-4">
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Preencha os dados abaixo. O Anunciante entrará em contato em instantes.
                </p>
              </div>

              {submitted && activeLead ? (
                (() => {
                  const activeLeadMessages = chatMessages.filter(
                    (msg) => msg.leadId === activeLead.id,
                  );
                    ...
                    <div className="space-y-4 animate-fade-in text-left">
                      ...
                      <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-3 flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-slate-500">
                            Atendimento garantido com atribuição ao indicador{" "}
                            <strong>{activeLead.indicatorName}</strong>.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="border border-slate-100 rounded-2xl overflow-hidden bg-slate-50 shadow-inner flex flex-col h-[350px]">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <span className="text-[9px] text-slate-400 block">
                                Atendimento Oficial pelo Portal
                              </span>
                            </div>
                          </div>
                        ...
                        <div className="bg-slate-100 border-t border-slate-200/60 px-3 py-1.5 flex items-center gap-1.5 text-[9px] text-slate-500">
                          ...
                          <span>
                            Mensagens monitoradas. Proibido compartilhar WhatsApp ou links externos.
                          </span>
                        </div>
              ...
              <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-100 space-y-2">
                <span className="text-[10px] font-bold text-blue-950 uppercase block tracking-wider font-mono">
                  Plataforma Segura
                </span>
                <p className="text-[10px] text-slate-500 leading-normal">
                  Seus dados serão compartilhados de forma totalmente confidencial e protegida de
                  acordo com as leis de privacidade. Atendimento prioritário e acompanhamento
                  integral.
                </p>
              </div>
            </div>
      ...
      {activeTab === "portal" && (
        <div className="bg-white rounded-3xl border border-slate-100 shadow-xl p-6 sm:p-8 max-w-4xl mx-auto space-y-6 text-left animate-fade-in">
          <div className="text-center max-w-xl mx-auto space-y-1.5">
            ...
            <h2 className="font-display font-bold text-slate-950 text-xl sm:text-2xl tracking-tight">
              Portal de Acompanhamento do Cliente
            </h2>
            <p className="text-xs text-slate-500 leading-relaxed">
              Consulte o status das suas propostas, acesse a ficha técnica e converse diretamente
              com as lojas parceiras em nosso chat seguro e monitorado.
            </p>
          </div>
          ...
          <div className="bg-slate-50 rounded-2xl border border-slate-200/80 p-5 space-y-3.5">
            <div>
              <label className="block text-[10px] font-bold text-slate-700 uppercase tracking-wider mb-1.5">
                Digite seu E-mail ou Telefone cadastrado
              </label>
            ...
            <div className="flex items-start gap-2 text-[10px] text-slate-500">
              ...
              <span>
                Seus dados são confidenciais. Para abrir seus atendimentos ativos, digite exatamente
                o mesmo telefone ou e-mail que você utilizou ao preencher o formulário de interesse
                de qualquer produto.
              </span>
            </div>
          </div>
          ...
          {!portalLookupPhoneOrEmail.trim() ? (
            <div className="border border-dashed border-slate-200 rounded-2xl py-12 text-center text-xs text-slate-400">
              Por favor, digite seu e-mail ou telefone acima para pesquisar seus atendimentos
              ativos.
            </div>
          ) : (
            (() => {
                ...
                return (
                  <div className="border border-dashed border-slate-200 rounded-2xl py-12 text-center space-y-2">
                    ...
                    <p className="text-xs text-slate-400 font-medium">
                      Nenhum atendimento em andamento para "{portalLookupPhoneOrEmail}"
                    </p>
                    <p className="text-[10px] text-slate-400 max-w-xs mx-auto leading-normal">
                      Verifique se digitou o e-mail ou telefone corretamente ou envie uma nova
                      proposta na aba <strong>"Visualizar Oferta"</strong>.
                    </p>
                  </div>
                );
              }
                        ...
                        >
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div className="space-y-1 text-left">
                              ...
                              <h4 className="font-display font-bold text-slate-900 text-sm sm:text-base mt-1">
                                {lead.productTitle}
                              </h4>
                              ...
                              <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-[10px] text-slate-400 mt-1">
                                <span>
                                  Anunciante:{" "}
                                  <strong className="text-slate-600">{advertiserName}</strong>
                                </span>
                                <span>•</span>
                                <span>
                                  Enviado em:{" "}
                          ...
                          {lead.status === "visita_agendada" && lead.visitDate && (
                            <div className="mt-3.5 p-3 rounded-xl bg-amber-50/60 border border-amber-100 text-[11px] text-amber-950 flex items-center gap-2">
                              ...
                              <span>
                                Sua visita à loja física está agendada para o dia{" "}
                                <strong>
                                  {new Date(lead.visitDate).toLocaleDateString("pt-BR")}
                                </strong>{" "}
                                às <strong>{lead.visitDate.substring(11, 16)}h</strong>. Não se
                                esqueça de sinalizar a sua chegada!
                              </span>
                            </div>
                          )}
                            ...
                            <div className="mt-4 pt-4 border-t border-slate-100 animate-fade-in text-left">
                              <div className="bg-slate-50 rounded-2xl border border-slate-200/80 overflow-hidden flex flex-col h-[320px]">
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    <div className="text-left">
                                      <h5 className="font-bold text-xs text-slate-100">
                                        Atendimento Oficial • {advertiserName}
                                      </h5>
                                      <p className="text-[9px] text-slate-400">
                                        Atribuído à comissão de indicação de {lead.indicatorName}
                                      </p>
                                    </div>
                                  </div>
                                ...
                                <div className="bg-slate-100 border-t border-slate-200/60 px-4 py-2 flex items-center gap-1.5 text-[9px] text-slate-500">
                                  ...
                                  <span>
                                    Mantenha as negociações aqui para garantir as condições
                                    especiais do portal.
                                  </span>
                                </div>
