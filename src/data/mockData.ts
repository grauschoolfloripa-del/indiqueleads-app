...
export const INITIAL_INDICATORS: Indicator[] = [
  {
    ...
    balanceAvailable: 7400.0,
    balancePending: 3500.0,
    city: "São Paulo",
    state: "SP",
  },
  {
...
export const INITIAL_LEADS: Lead[] = [
  {
    ...
    notes:
      "Venda de R$ 12.500.000 efetuada. Cliente pagou à vista. Comprovante anexado no fechamento.",
...
export const INITIAL_SIMULATIONS: FinancingSimulation[] = [
  {
    ...
    approvedContract: {
      ...
      interestRate: 1.65,
      additionalNotes:
        "Contrato pré-aprovado disponível para assinatura. Comissão do indicador garantida em caso de assinatura física.",
    },
...
export const INITIAL_CHAT_MESSAGES: ChatMessage[] = [
  ...
  },
  {
    ...
    originalText:
      "Mariana, me passa seu telefone de whatsapp para eu te mandar a localização exata e conversarmos direto por lá, ok?",
