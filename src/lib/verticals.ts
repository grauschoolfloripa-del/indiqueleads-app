...
export const VERTICALS: Record<Category, VerticalConfig> = {
  imovel: {
    ...
    attributes: [
      { key: "finalidade", label: "Finalidade", type: "select", options: ["Residencial", "Comercial", "Investimento"] },
      { key: "tipo", label: "Tipo", type: "select", options: ["Apartamento", "Casa", "Cobertura", "Lote", "Sala"] },
  ...
  moto: {
    ...
    attributes: [
      ...
      { key: "km", label: "KM", type: "number" },
      { key: "tipo", label: "Tipo", type: "select", options: ["Naked", "Esportiva", "Custom", "Trail", "Scooter"] },
    ],
    statusFlow: STD_FLOW,
    commissionModel: "presencial_digital",
  ...
  saude: {
    ...
    attributes: [
      ...
      { key: "especialidade", label: "Especialidade", type: "select",
        options: ["Odontologia estética", "Estética avançada", "Cirurgia plástica", "Oftalmologia", "Bariátrica", "Exames de imagem", "Outro"] },
    ...
    leadFields: [
      { key: "melhorHorario", label: "Melhor horário para contato", type: "text" },
    ],
    statusFlow: [
      "lead_recebido",
      "triagem",
  ...
  energia_solar: {
    ...
    attributes: [
      ...
      { key: "tipoImovel", label: "Tipo de imóvel", type: "select",
  ...
  educacao: {
    ...
    attributes: [
      ...
      { key: "nivel", label: "Nível", type: "select", options: ["Curta duração", "Graduação", "MBA/Pós", "Idiomas", "Técnico"] },
    ],
    leadFields: [
      { key: "cursoInteresse", label: "Curso de interesse", type: "text" },
    ],
    statusFlow: [
      "lead_recebido",
      "contato_feito",
  ...
  turismo: {
    ...
    attributes: [
      ...
      { key: "tipoPacote", label: "Tipo", type: "select", options: ["Lua de mel", "Cruzeiro", "Iate", "Evento/Camarote", "Personalizado"] },
    ],
    statusFlow: [
      "lead_recebido",
      "contato_feito",
  ...
  seguros: {
    ...
    attributes: [
      { key: "tipoSeguro", label: "Tipo de seguro", type: "select",
        options: ["Vida", "Residencial", "Automotivo", "Empresarial", "Saúde empresarial", "Garantia estendida"] },
  ...
  veiculos_pesados: {
    ...
    attributes: [
      { key: "tipo", label: "Tipo", type: "select",
        options: ["Caminhão", "Trator", "Colheitadeira", "Ônibus", "Retroescavadeira", "Guindaste", "Implemento"] },
      { key: "marca", label: "Marca", type: "text" },
  ...
  imoveis_comerciais_locacao: {
    ...
    attributes: [
      { key: "tipoImovel", label: "Tipo", type: "select", options: ["Sala comercial", "Loja", "Galpão", "Área industrial", "Coworking"] },
