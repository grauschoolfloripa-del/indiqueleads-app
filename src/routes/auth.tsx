        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <>
                ...
                <label className="block">
                  ...
                  <select
                    ...
                    className="mt-1 w-full py-2 px-3 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full flex items-center justify-center gap-2 bg-blue-700 hover:bg-blue-800 disabled:opacity-60 text-white font-semibold py-2.5 rounded-lg transition"
            >
